...
@REM
@REM version:
@REM  MPLABX-v6.20, XC32-v4.35, MCC-v5.5.0
@REM
@REM usage:
@REM  1) get repository with
@REM     ()> git clone https://github.com/stefanluethin-microchip/CICDgh_samd21xplp
@REM     ()> cd CICDgh_samd21xplp
@REM     
@REM  2) open dos-shell and set OS-path:
@REM    (CICDgh_samd21xplp\)>  .\CICDgh_samd21xplp\mdb\CICDgh_samd21xplp_test1_comp.bat
@REM 
